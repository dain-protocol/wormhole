...
import (
	...
	"github.com/dain-protocol/wormhole/node/pkg/watchers"
	"github.com/dain-protocol/wormhole/node/pkg/watchers/ibc"
	ethcrypto "github.com/ethereum/go-ethereum/crypto"

	"github.com/dain-protocol/wormhole/node/pkg/watchers/cosmwasm"

	"github.com/dain-protocol/wormhole/node/pkg/watchers/algorand"
	"github.com/dain-protocol/wormhole/node/pkg/watchers/aptos"
	"github.com/dain-protocol/wormhole/node/pkg/watchers/evm"
	"github.com/dain-protocol/wormhole/node/pkg/watchers/near"
	"github.com/dain-protocol/wormhole/node/pkg/watchers/solana"
	"github.com/dain-protocol/wormhole/node/pkg/watchers/sui"
	"github.com/dain-protocol/wormhole/node/pkg/wormconn"

	"github.com/dain-protocol/wormhole/node/pkg/db"
	"github.com/dain-protocol/wormhole/node/pkg/telemetry"
	"github.com/dain-protocol/wormhole/node/pkg/version"
	"github.com/gagliardetto/solana-go/rpc"
	"go.uber.org/zap/zapcore"

	"github.com/dain-protocol/wormhole/node/pkg/common"
	"github.com/dain-protocol/wormhole/node/pkg/devnet"
	"github.com/dain-protocol/wormhole/node/pkg/node"
	"github.com/dain-protocol/wormhole/node/pkg/p2p"
	"github.com/dain-protocol/wormhole/node/pkg/supervisor"
	promremotew "github.com/dain-protocol/wormhole/node/pkg/telemetry/prom_remote_write"
...
func init() {
	...
	solanaRPC = node.RegisterFlagWithValidationOrFail(NodeCmd, "solanaRPC", "Solana RPC URL (required)", "https://api.testnet.solana.com", []string{"http", "https"})
